...
<head>
    ...
    @if(env('IS_DEMO'))
        ...
        <meta  itemprop="name" content="Soft UI Dashboard Laravel  & UPDIVISION" />
        ...
        <meta  name="twitter:title" content="Soft UI Dashboard Laravel  & UPDIVISION" />
        ...
        <meta  property="og:title" content="Soft UI Dashboard Laravel  & UPDIVISION" />
